...
//-------------------------------
function generatePattern(pattern, row, min, max, needles, prevRowNs, nextRowNs, generate, dir, speed, stitch, roller, width, currentCarrier, backpassCarrier, rowColCt) {	generated = [];
	avoidOnBack = [];
